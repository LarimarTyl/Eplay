...
<div class="container">
    ...
    <div class="player">
        ...
        <nav class="navbar  navbar-top navbar-default player-top" role="navigation">
            <a class="navbar-brand">
                    <span class="glyphicon"><img src="../../img/picture/686589.png" alt="" width="55px">
                        游戏陪玩</span></a>
    ...
    <div class="together">
        ...
        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
            <div class="thumbnail">
                <a class="pull-top" href="#">
                    <img class="img" src="../../img/game-picture/ia_10031.jpg" alt="Image">
                </a>
                <div class="media-body">
                    <h4 class="media-heading">LOL上分厅</h4>
                    <p class="dec">
                    <p class="admin"><span class="glyphicon">
                                    <img src="../../img/user/ia_10068.jpg" alt="">迷人的微笑</span></p>
        ...
        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
            <div class="thumbnail">
                <a class="pull-top" href="#">
                    <img class="img" src="../../img/game-picture/ia_10032.jpg" alt="Image">
                </a>
                <div class="media-body">
                    <h4 class="media-heading">LOL开黑二厅</h4>
                    <p class="dec">
                    <p class="admin"><span class="glyphicon">
                                    <img src="../../img/user/ia_10047.jpg" alt="">小迷糊</span></p>
        ...
        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
            <div class="thumbnail">
                <a class="pull-top" href="#">
                    <img class="img" src="../../img/game-picture/ia_10033.jpg" alt="Image">
                </a>
                <div class="media-body">
                    <h4 class="media-heading">LOL开黑一厅</h4>
                    <p class="dec">
                    <p class="admin"><span class="glyphicon">
                                    <img src="../../img/user/ia_10065.jpg" alt="">大鼻子露^(*￣(oo)￣)</span></p>
        ...
        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
            <div class="thumbnail">
                <a class="pull-top" href="#">
                    <img class="img" src="../../img/game-picture/ia_10034.jpg" alt="Image">
                </a>
                <div class="media-body">
                    <h4 class="media-heading">LOL自由开黑厅</h4>
                    <p class="dec">
                    <p class="admin"><span class="glyphicon">
                                    <img src="../../img/user/ia_10075.jpg" alt="">怼怼o(=•ェ•=)o</span></p>
        ...
        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
            <div class="thumbnail">
                <a class="pull-top" href="#">
                    <img class="img" src="../../img/game-picture/ia_10035.jpg" alt="Image">
                </a>
                <div class="media-body">
                    <h4 class="media-heading">绝地求生开黑厅</h4>
                    <p class="dec">
                    <p class="admin"><span class="glyphicon">
                                    <img src="../../img/user/ia_10065.jpg" alt="">寒王</span></p>
        ...
        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
            <div class="thumbnail">
                <a class="pull-top" href="#">
                    <img class="img" src="../../img/game-picture/ia_10036.jpg" alt="Image">
                </a>
                <div class="media-body">
                    <h4 class="media-heading">DNF跨4A打团厅</h4>
                    <p class="dec">
                    <p class="admin"><span class="glyphicon">
                                    <img src="../../img/user/ia_10047.jpg" alt="">苏然染</span></p>
                    <p class="number">45人</p>
                    </p>
                </div>
            </div>
        ...
        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
            <div class="thumbnail">
                <a class="pull-top" href="#">
                    <img class="img" src="../../img/game-picture/ia_10105.jpg" alt="Image">
                </a>
                <div class="media-body">
                    <h4 class="media-heading">自走棋开黑厅</h4>
                    <p class="dec">
                    <p class="admin"><span class="glyphicon">
                                    <img src="../../img/user/ia_10118.jpg" alt="">棋菜·没有子</span></p>
        ...
        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
            <div class="thumbnail">
                <a class="pull-top" href="#">
                    <img class="img" src="../../img/game-picture/ia_10037.jpg" alt="Image">
                </a>
                <div class="media-body">
                    ...
                    <p class="admin">
                                <span class="glyphicon">
                                    <img src="../../img/user/user.JPEG" alt="">超级伏地魔</span></p>
    ...
    <div class="item rank">
        ...
        <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 ranks ">
            <div class="rank-item">
                ...
                <div class="best">
                    <div class="first">
                        <img src="../../img/user/ia_10072.jpg">
                    </div>
                    <div class="second">
                        <img src="../../img/user/ia_10074.jpg">
                    </div>
                </div>
        ...
        <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 ranks">
            <div class="rank-item">
                <p class="rank-list">
                    <img src="../../img/bg/ia_10310.png"> 土豪榜
                </p>
                <div class="best">
                    <div class="first">
                        <img src="../../img/user/ia_10072.jpg">
