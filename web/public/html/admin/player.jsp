    ...
    <div class="panel-body">
        <form class="form-inline" method="get" action="">
            <div class="form-group">
                <label for="playLoginName">主播名称</label>
                <input type="text" class="form-control" id="playLoginName" value="" name="loginName">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label for="playGameName">游戏名</label>
                <input type="text" class="form-control" id="playGameName" value="" name="gender">
            </div>
            ...
            <div class="modal-body">
                <form class="form-horizontal" id="new_player_form">
                    ...
                    <div class="form-group">
                        ...
                        <label for="new_love" class="col-sm-2 control-label">陪玩游戏</label>
                        <div class="col-sm-4">
                            <input type="text" class="form-control" id="new_love" placeholder="陪玩游戏" name="love">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="new_level" class="col-sm-2 control-label">段位水平</label>
                        <div class="col-sm-4">
                            <input type="text" class="form-control" id="new_level" placeholder="段位水平" name="level">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="new_introduce" class="col-sm-2 control-label">个人介绍</label>
                        <div class="col-sm-10">
                            <textarea rows="3" class="form-control" id="new_introduce" placeholder="个人介绍" name="introduce"></textarea>
                        </div>
                    </div>
                </form>
            </div>
    ...
    function editplayer(id) {
        $.ajax({
            ...
            success:function(data) {
                $("#edit_id").val(data.id);
                $("#edit_userName").val(data.loginName);
