...
public interface UserDao {
    ...
    public List<UserBean> selectUsersBySpend();//查找高消费用户1
    public List<UserBean> selectUsersByStatus(int status);//根据用户状态查找用户（玩家、用户、管理员）1
    public List<UserBean> selectUsersByender(String gender);//根据性别查找用户1
